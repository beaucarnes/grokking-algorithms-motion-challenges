...
class HashTable():
    ...
    def get(self, key):
        ...
        # First, check if slot is empty. If not, go through linked list in slot until key is found. Return value.



    def get_hash(self, key):
        # Return a number based on a string that is passed in. Number for a particular string should always be the same.



ht = HashTable()
ht.set('Beau', '555-555-5555')
ht.set('Corwin', '555-777-7777')
print(ht.get('Corwin'))